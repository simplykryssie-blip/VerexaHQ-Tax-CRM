...
export const createClientSchema = z.object({
  ...
  mailingLine1: z.string().trim().max(200).optional(),
  mailingLine2: z.string().trim().max(200).optional(),
  mailingCity: z.string().trim().max(120).optional(),
  mailingState: z.string().trim().max(60).optional(),
  mailingPostalCode: z.string().trim().max(20).optional(),
  mailingCountry: z.string().trim().max(60).optional(),
