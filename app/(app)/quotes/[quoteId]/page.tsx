...
export default async function QuoteDetailPage({ params }: { params: Promise<{ quoteId: string }> }) {
  ...
  if (!quote) notFound(); const send = await requirePermission(workspace.workspace.id,"quotes.send");
