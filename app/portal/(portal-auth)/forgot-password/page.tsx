    ...
    return (
      <Card>
        ...
        <CardContent className="text-center">
          <Link href="/portal/sign-in" className="text-sm text-primary font-medium hover:underline">
            Back to sign in
          </Link>
        </CardContent>
      </Card>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <p className="mt-4 text-center text-sm text-muted-foreground">
          <Link href="/portal/sign-in" className="text-primary font-medium hover:underline">
            Back to sign in
          </Link>
        </p>
      </CardContent>
